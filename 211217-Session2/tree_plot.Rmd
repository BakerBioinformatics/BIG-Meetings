...
tree <- ggplot() + 
          ...
          scale_fill_identity() + 
          theme_bw() +
          scale_x_continuous(breaks = NULL) +  #gets rid of the tickmarks and gridlines;
...
Christmas Tree code obtained from [here](https://t-redactyl.io/blog/2016/12/a-very-ggplot2-christmas.html)
